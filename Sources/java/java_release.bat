rem Build a release version of the Java Wrapper and example
...
copy c:\engine5\source\output\release\coengine.lib TestFrame

rem Compile the JNI dll
msdev c:\engine5\source\java\TestFrame\TestFrame.dsw /MAKE "TestFrame - Win32 Release" /REBUILD
